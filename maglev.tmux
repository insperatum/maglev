...
TMUX_COLOR=${TMUX_COLOR:-colour4} # blue
apply_theme() {
    left_separator=''
    ...
    pane_active_border_fg=$TMUX_COLOR # blue
    ...
    display_panes_active_colour=$TMUX_COLOR # blue
    display_panes_colour=$TMUX_COLOR # blue
...
#     status_left="#[fg=$session_fg,bg=$session_bg,bold] ❐ #S #[fg=$session_bg,bg=$status_bg,nobold]$left_separator_black"
    status_left="#[fg=$session_fg,bg=$session_bg,bold] ❐ $HOSTNAME:#S #[fg=$session_bg,bg=$status_bg,nobold]$left_separator_black"
    ...
    window_status_current_bg=$TMUX_COLOR # blue
    ...
    window_status_last_fg=$TMUX_COLOR # blue
    ...
    # clock
    clock_mode_colour=$TMUX_COLOR # blue
